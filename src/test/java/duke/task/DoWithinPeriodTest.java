...
public class DoWithinPeriodTest {
    ...
    public void testToString() {
        ...
        assertEquals("[W][NOT DONE] To Complete Test (within: 13/2/2017 1556 - 15/2/2017 1600)", newDoWithinPeriod.toString());

        newDoWithinPeriod.markAsDone();
        assertEquals("[W][DONE] To Complete Test (within: 13/2/2017 1556 - 15/2/2017 1600)", newDoWithinPeriod.toString());
    }
}