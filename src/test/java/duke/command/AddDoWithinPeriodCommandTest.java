...
public class AddDoWithinPeriodCommandTest {
    ...
    public void testDeadlineCommand() throws DukeException, IOException {
        ...
        assertEquals( "[W][NOT DONE] To complete work (within: 1/1/2019 1830 - 3/2/2019 1900)", newTaskList.getTask(0).toString());

        newTaskList.getTask(0).markAsDone();
        assertEquals( "[W][DONE] To complete work (within: 1/1/2019 1830 - 3/2/2019 1900)", newTaskList.getTask(0).toString());

        try {
            doWithinPeriodCommand = new AddDoWithinPeriodCommand(false, "dowithin To complete work /from 5/12/2019 1830 /to 3/2/2019 1900");
            doWithinPeriodCommand.execute(newTaskList, newUi, newStorage);
